...
<div>How do you show independence on a map? Is it enough for a diplomat and a monarch to mark up an older map with red ink? Or does a nation only appear when an entirely new map is drawn?</div>